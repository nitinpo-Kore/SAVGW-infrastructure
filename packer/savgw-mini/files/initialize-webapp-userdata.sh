...
echo "REACT_APP_API_BASE_URL=http://${PUBLIC_IPV4}/api/v1" > /home/admin/apps/savgw-webapp/.env
cd /home/admin/apps/savgw-webapp && sudo npm install --unsafe-perm && npm run build
