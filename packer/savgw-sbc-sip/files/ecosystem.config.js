module.exports = {
  ...
  },
  {
    ...
    script: 'app.js',
    instance_var: 'INSTANCE_ID',
    out_file: '/home/admin/.pm2/logs/savgw-sbc-options-handler.log',
    err_file: '/home/admin/.pm2/logs/savgw-sbc-options-handler.log',
    exec_mode: 'fork',
    instances: 1,
    autorestart: true,
    watch: false,
  ...
  },
  {
    ...
    script: 'app.js',
    instance_var: 'INSTANCE_ID',
    out_file: '/home/admin/.pm2/logs/savgw-sbc-registrar.log',
    err_file: '/home/admin/.pm2/logs/savgw-sbc-registrar.log',
    exec_mode: 'fork',
    instances: 1,
    autorestart: true,
    watch: false,
